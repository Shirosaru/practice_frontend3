...
function Home() {
    ...
    // Handle form submission to run Python script
    const handleSubmit = async ()=>{
        const { exec } = __turbopack_require__("[externals]/child_process [external] (child_process, cjs)");
        exec(`python3 backend.py "${inputString}"`, (error, stdout, stderr)=>{
            if (error) {
            ...
            setOutputString(stdout.trim()); // Get the output of the Python script
        });
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dbdf60._.js.map